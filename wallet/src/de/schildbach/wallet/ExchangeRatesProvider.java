...
/**
 * @author Andreas Schildbach, Litecoin Dev Team, Machinecoin Dev Team
 */
public class ExchangeRatesProvider extends ContentProvider
{
	...
	static
	{
		try
		{
            BTCE_URL = new URL("http://api.machinecoin.org/ticker/?action=exchangerate&base=MAC&alt=USD"); // MAC in USD
            BTCE_EURO_URL = new URL("http://api.machinecoin.org/ticker/?action=exchangerate&base=MAC&alt=EUR"); // MAC in EUR
		}
