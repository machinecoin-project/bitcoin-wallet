...
public class ExchangeRatesProvider extends ContentProvider
{
	...
	static
	{
		try
		{
            BTCE_URL = new URL("http://api.machinecoin.org/ticker/?action=exchangerate&base=MAC&alt=USD");
            BTCE_EURO_URL = new URL("http://api.machinecoin.org/ticker/?action=exchangerate&base=MAC&alt=EUR");
            VIRCUREX_URL = new URL("http://api.machinecoin.org/ticker/?action=lastexchange&base=MAC&alt=USD");
		}
